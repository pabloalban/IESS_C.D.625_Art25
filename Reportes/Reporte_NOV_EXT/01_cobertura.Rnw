...
\vspace{2cm}
\begin{flushleft}
\hspace*{-2cm}{\color{iess_green}{\rule{10cm}{1pt}}}
\end{flushleft}
...
\parbox{\textwidth}{ 
  ...
  {\centering \fontsize{18pt}{22} { \selectfont{ \bfseries{ \textcolor{iess_blue} 
    { \Sexpr{REP_tit} } } } \par } } 
}
...
\vspace{1.3cm}
\hspace*{7cm}{\fontsize{15}{18}{\bfseries{\selectfont{\textcolor{iess_blue}{Quito, 18 de mayo de 2021}}}}}
\normalfont
\clearpage
